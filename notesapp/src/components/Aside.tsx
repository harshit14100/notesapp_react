  ...
  return (
    ...
    <div className='bg-[#181818] min-w-1/5 h-screen text-white  font-sans'>
      ...
      <div>
        ...
        <div className='flex px-6 gap-3.5 text-2xl items-center cursor-pointer  text-zinc-300 py-2.5 hover:bg-red-600 hover:text-amber-50'>
        <TbStar /> <button className='text-sm font-bold '>Favorites</button>
      </div>
      <div className='flex px-6 gap-3.5 text-2xl text-zinc-300 cursor-pointer items-center  py-2.5 hover:bg-red-600 hover:text-amber-50 '>
